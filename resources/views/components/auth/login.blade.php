    ...
    <div class="relative p-4 w-full max-w-md">
        ...
        <div class="relative bg-white rounded-lg shadow-sm">
            ...
            <div class="p-4 md:p-5">
                <form class="space-y-4" action="{{ route('login') }}" method="POST" id="form-login">
                    @csrf
                    <div>
                ...
                <!-- Register Form -->
                <form id="form-register" class="space-y-4 hidden" method="POST" action="{{ route('register') }}">
                    @csrf
                    <div>
                        <label for="name" class="block mb-2 text-sm font-medium text-orange-800">Nama
                            Lengkap</label>
                    ...
                    <div>
                        <label for="email" class="block mb-2 text-sm font-medium text-orange-800">Email</label>
                    ...
                    <div>
                        <label for="password" class="block mb-2 text-sm font-medium text-orange-800">Password</label>
