        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="flex md:order-2 space-x-3 items-center md:space-x-4 rtl:space-x-reverse">
                ...
                <div class="text-orange-700" x-data="{ open: false }">
                    ...
                    <!-- Overlay gelap -->
                    <div class="fixed inset-0 bg-black/30 z-[99998]" x-show="open"
                    ...
                    <!-- Drawer dari kanan -->
                    <div class="fixed top-0 right-0 h-full bg-blue-400 shadow-lg z-[99999] transform transition-transform duration-300 ease-in-out
                                w-[80%] sm:w-[400px]"
                        ...
                        <div class="h-full flex flex-col bg-white shadow-xl overflow-y-auto">
                                ...
                                <div class="mt-8" x-data>
                                    <div class="flow-root">
                                        <ul role="list" class="-my-6 divide-y divide-gray-200">
                                                    ...
                                                    <div class="ml-4 flex-1 flex flex-col">
                                                        <div>
                                                            <div
                                                                ...
                                                                <p class="ml-4">
                                                                    <span>Rp </span><span
                                                                        x-text="(item.price * item.quantity).toLocaleString('id-ID')"></span>
                                                                </p>
                                                            </div>
                                                        </div>
                                                        <div class="flex-1 flex items-end justify-between text-sm">
                                                            <div class="flex items-center space-x-2">
                                                                <button
                                                                    ...
                                                                    :class="{
                                                                        'opacity-50 cursor-not-allowed': item
                                                                            .quantity <=
                                                                            1
                                                                    }">
                                            ...
                                            <li x-show="$store.cart.items.length === 0" class="py-6 text-center">
                                                <p class="text-gray-500">Keranjang belanja Anda kosong.</p>
                                                <button @click="open = false"
                                                    class="mt-4 text-orange-600 font-medium">
                                                    Belanja Sekarang
                                                </button>
                                            </li>
                                        </ul>
                            ...
                            <div class="border-t border-gray-200 py-6 px-4 sm:px-6">
                                <div class="flex justify-between text-base font-medium text-gray-900">
                                    ...
                                    <p>
                                        <span>Rp </span><span
                                            x-text="$store.cart.totalAmount.toLocaleString('id-ID')"></span>
                                    </p>
                                </div>
                                <p class="mt-0.5 text-sm text-gray-500">Pengiriman dan pajak dihitung saat checkout.
                                </p>
                                <div class="mt-6">
                                    <button @click="open = false; checkoutOpen = true" disabled
                                        x-bind:disabled="$store.cart.items.length === 0"
                                        x-bind:class="{
                                            'opacity-50 cursor-not-allowed': $store.cart.items.length ===
                                                0,
                                            'hover:bg-orange-700': $store.cart.items.length > 0
                                        }"
